...
This is a re-write of "Cone Animation.ino" made to use tinyNeoPixel instead
of fastLED. None of the mechanics of the code have been changed, only the
library used to control the led strip's. 
...
tinyNeoPixel pixels = tinyNeoPixel(25, PIN_PC0, NEO_GRB + NEO_KHZ800);
...
void loop() {
  ...
  Pixel2 = Pixel2 + 1;
  pixels.setPixelColor(Pixel2, pixels.Color(255, 140, 0));
  ...
  Pixel3 = Pixel3 + 1;
  pixels.setPixelColor(Pixel3, pixels.Color(255, 140, 0));
